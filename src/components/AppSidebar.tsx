...
const navItems = [
  ...
  { title: "Job Positions", url: "/positions", icon: Briefcase },
        ...
        <div className="flex items-center gap-3">
          ...
          {!collapsed && (
            <div className="flex flex-col">
              <span className="text-sm font-medium text-sidebar-primary-foreground">John Doe</span>
              <span className="text-xs text-sidebar-foreground">HR Manager</span>
            </div>
          )}
        </div>
      </SidebarFooter>
